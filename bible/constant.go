...
var OldStatementBookCodes = []string{
	"gen",
	"exo",
	"lev",
	"num",
...
var NewStatementBookCodes = []string{
	"mat",
	"mrk",
	"luk",
	"jhn",
...
// totalVersesGroupByBookAndChapter Total verses group by book and chapter
// The first index number is total chapters
var totalVersesGroupByBookAndChapter = map[string][]int{
	...
	"1ch": {29, 54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40, 14, 17, 29, 43, 27, 18, 18, 8, 30, 19, 32, 31, 31, 32, 34, 21, 30},
